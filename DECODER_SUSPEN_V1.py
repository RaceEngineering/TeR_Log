...
if __name__ == "__main__":
    try:
        ...
        decoder.decode_log("D1F3.log", "test0903_suspen_run3.xlsx", "xlsx", selected_signals = ["Timestamp","a_y","a_x","v_x","v_y","Yaw_Rate_z","Front_Susp","STEERING_ANGLE", "flTemp","frTemp","rlTemp","rrTemp","BPPS","ROLL","PITCH","SAchassis"], rollgradient=["ROLL"], aceleracion_lateralVSroll=["ROLL","a_y"],aceleracion_longitudinalVSpitch=["PITCH","a_x"],tempsVSsteeringVSaceleracion_latVSaceleracion_long=["flTemp","frTemp","rlTemp","rrTemp","STEERING_ANGLE","a_y","a_x"],velVSaceleracion_latVSsteeringVS_SAchassis=["v_x","STEERING_ANGLE","a_y","SAchassis"], velVSaceleracion_latVSsteeringVSyow_rate=["v_x","a_y","STEERING_ANGLE","Yaw_Rate_z"])  # Cambia Signal1, Signal2 por los nombres reales de las señales
    except Exception as e:
