...
class UniversalLogDecoder:
    ...
    def decode_log(self, log_path: str, output_format: str, output_file: str):
        ...
        if output_format == 'csv':
            ...
            self._write_to_json(grouped_decoded, output_file)
    ...
    def _write_to_json(self, grouped_decoded: Dict[str, List[float]], json_file: str):
        with open(json_file, 'w') as file:
            json.dump(grouped_decoded, file, indent=4)
...
decoder.decode_log("RUN0.log", "json", "decoded_log.json")  # Cambia a 'csv' o 'xlsx' según necesites
