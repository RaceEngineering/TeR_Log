...
class Signal:
    ...
    def _operate(self, otra, operador):
        ...
        nuevo_nombre = f"{operador} de {self.nombre} y {otra.nombre}"
...
if __name__ == "__main__":
    ...
    signals.add_signal("Señal 1", [6, 4, 2, 5])
    signals.add_signal("Señal 2", [25, 20, 3, 1])
    signals.add_signal("Señal 3", [5, 5, 5, 5, 2])

    resultado = signals.evaluate_expression("Señal 1 + Señal 2 + Señal 3")
