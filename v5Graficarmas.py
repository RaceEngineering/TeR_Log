...
class Signal:
    ...
    def decode_log(self, log_path: str, csv_final: str, signals_to_plot: List[str] = None, plot_save_path: str = None):
...
decoder.decode_log("RUN0.log", "decoded_log.csv", signals_to_plot=["PITCH", "ROLL", "YAW"], plot_save_path="combined_plot.png")
